...
class ComputerTransferSingleActionPi(object):
...
class TrainerTransferSingleActionPi(object):
    def __init__(self, empowerment):
        self.transition = empowerment.transition
        self.source = empowerment.source
        self.planning = empowerment.planning
...
class VariationalTransferSingleActionPiEmpowerment(VariationalBaseEmpowerment):
